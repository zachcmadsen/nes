...
const NAMETABLE_SELECT_MASK: u16 = 0b0000_1100_0000_0000;
...
impl Address {
    ...
    pub fn nametable_select(&self) -> u8 {
        ((self.0 & NAMETABLE_SELECT_MASK) >> 10) as u8
    }

    pub fn set_nametable_select(&mut self, bits: u8) {
        self.0 = (self.0 & !NAMETABLE_SELECT_MASK)
            | (bits as u16 & NAMETABLE_SELECT_MASK) << 10;
    }
